...
if (!isset($_SESSION['uniqueid']))
{
  ...
  <head>
    ...
    .navbar-nav > li > a
    {padding-top:5px !important; padding-bottom:15px !important; height:50px;}
  ...
  <section>
    <nav>
      <div class="navbar bar">
        <div class="h_padding bar" id="navbarTogglerDemo02">
          <br>
          <h4>  Welcome back <?php echo $_SESSION['user']; ?>!</h4>
          <a href="logout.php" class="bar-item navbutton btnsize">LOGOUT
          </a>
          <a href="view_profile.php" class="bar-item navbutton btnsize">VIEW PROFILE
          </a>
          </div>
        </div>
      </nav>
    ...
    <center>
      ...
      <table class="interfaceTable">
        <tr>
          <td class="col-45 txt" align=center>
            <a href="search_vehicle_interface.php"><button>Search for vehicle</button></a></td>
            <td class="col-55 txt" align=center>
              <b>Search for any vehicle in the parking lot to contact the driver in case of any emergency/to just view the slot number of the parked vehicle</b>
            </td>
          </tr>
          <tr>
            <td class="col-45 txt" align=center>
              <a href="fix_slots_interface.php"><button>Fix number of slots</button></a></td>
              <td class="col-55 txt" align=center><b>Set the number of slots available in your parking lot</b></td>
          </tr>
          <tr>
            <td class="col-45 txt" align=center>
              <a href="view_vehicles_interface.php"><button>View vehicles in the lot</button></a></td>
